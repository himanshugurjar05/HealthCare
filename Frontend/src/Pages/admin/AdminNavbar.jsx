...
export default function AdminNavbar() {
  ...
  const navItems = [
    ...
    { path: '/admin/Doctor', label: 'Doctors', icon: Users },
    { path: '/admin/HealthPackage', label: 'HealthPackages', icon: UserPlus },
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-white font-bold text-xl">Admin Pannel</h1>
          </div>
