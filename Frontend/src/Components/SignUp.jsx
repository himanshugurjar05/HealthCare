          ...
          <div className="space-y-4">
            ...
            <div>
              <select
                ...
                value={formData.role}
                onChange={handelchange}
                className="block w-full px-3 py-3 border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              >
